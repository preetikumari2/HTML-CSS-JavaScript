...
const Profile = () => {
    return (
        <div className='profile'>
            <h1 className='prof'>About me</h1>
            <p className='prof'>The standard Lorem Ipsum passage, used since the 1500s
                ...
                sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequun
                tur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum 
